...
const fixTopStory = () => {
  ...
  topStoryTitleEl.innerText = 'Nicolas becomes favourite Pry Babies instrcutor.'
}
...
function fixTweet () {
  ...
  tweetText.innerText = "I just can't believe how quickly Nicolas became Pry Babies' favourite lead instructor. So proud, so proud."
}
